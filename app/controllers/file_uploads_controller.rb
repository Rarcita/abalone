...
class FileUploadsController < ApplicationController
  ...
  # the job class that processes the data. Ex: Selecting "Spawning Success"
  # in the form will post "SpawningSuccess" and process the
  # data with a SpawningSuccessJob.
  CATEGORIES = [
